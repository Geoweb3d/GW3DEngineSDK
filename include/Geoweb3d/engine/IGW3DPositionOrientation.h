...
namespace Geoweb3d
{
	...
	struct  GW3D_DLL IGW3DPositionOrientation
	{
		...
		enum AltitudeMode
		{
			...
			Relative = 1,
			//SKIP-CODE-BEGIN
					//First_Surface_Relative * Not Yet Implemented*
					//The elevation you set will be an offset from the highest first surface detected.
					// Q: Should we add an API to give a collection of points or envelopes for this mode?
		...
		///				the sdk.  Every time you call get_Location it does work.  Thus, if you need to
