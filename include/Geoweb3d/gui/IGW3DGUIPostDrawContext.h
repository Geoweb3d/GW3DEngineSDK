...
namespace GUI
{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	The post draw context </summary>
	///
	/// <remarks>	The post draw context is provided to the plugin just after any 3D view is drawn. </remarks>
	/// 
	/// <see cref="OnPreDraw"/>
	////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	struct IGW3DGUIPostDrawContext
	{
		...
		///
		/// <returns>	raster representation driver collection. </returns>
		////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		///
		/// <returns>	the line segment intersection test query collection. </returns>
		////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		/// <summary>	Gets the collection of 2D intersection tests. </summary>
		///
		/// <remarks>	A 2D intersection test will, when active, report all 2D vector representations
		/// 			(i.e. icons) that were intersected by the test's window coordinates in the previous
		/// 			draw.  All 2D intersection tests are created and accessed through the collection.
		/// 			</remarks>
		///
		/// <returns>	the 2D intersection test query collection. </returns>
		////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		///
		/// <remarks>	The scene graph context provides functions related to the Geoweb3d Engine scene
		/// 			graph.  This includes management of images and image palettes (such as for 
		/// 			extruded polygon textures) as well as retrieving file attributes for models and
		/// 			textures. </remarks>
		///
