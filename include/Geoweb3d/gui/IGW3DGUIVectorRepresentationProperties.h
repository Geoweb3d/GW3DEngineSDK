...
namespace GUI
{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	Capture Device Types </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	enum TEXTURE_SOURCE_TYPE
	{
		/// <summary>	No Device </summary>
		NO_CAPTURE			= 0,
		/// <summary>	DirectShow Device </summary>
		DIRECTSHOW			= 1,
		/// <summary>	Web Image </summary>
		WEB_IMAGE			= 2,
...
struct ColoredLinesProperties
{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	Display modes for colored line representations. </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////
...
struct BoxProperties
{
	...
	enum IndividualProperties
	{
		...
		/// <summary>	Exclude </summary>
		EXCLUDE				= 16,
		/// <summary>	Texture Source Type </summary>
		TEXTURE_SOURCE_TYPE = 17,
		/// <summary>	Texture Source (i.e. url) </summary>
		TEXTURE_SOURCE		= 18,
		/// <summary>	MAX - Do Not Use </summary>
		BP_IP_MAX			= 0xFFFF
	};
...
struct ProjectedImageProperties
{
	...
	enum IndividualProperties
	{
		...
		/// <summary>	Exclude </summary>
		EXCLUDE					= 17,
		/// <summary>	Capture device type </summary>
		TEXTURE_SOURCE_TYPE		= 18,
		/// <summary>	Capture device source definition </summary>
		TEXTURE_SOURCE			= 19,
		/// <summary>	Capture image refresh rate (WEB_IMAGE only) </summary>
		REFRESH_RATE			= 20, 
		/// <summary>	MAX - Do Not Use </summary>
		PIP_IP_MAX			= 0xFFFF
	};
...
struct SphereProperties
{
	...
	enum IndividualProperties
	{
		...
		RADIUS				= 13,
		/// <summary>	Slices (horizontal simplification), if -1, will auto generate a good quality based on radius</summary>
		SLICES				= 14,
		/// <summary>	Stacks (vertical simplification), if -1, will auto generate a good quality based on radius </summary>
		STACKS				= 15,
...
struct DrapedRingProperties
{
	...
	enum IndividualProperties
	{
		...
		/// <summary> Uses an outlining texture for contrast. </summary>
		OUTLINE_MODE = 9,
...
struct ExtrudedPolygonProperties
{
	...
	/// 			renderer. This means either they should be constructed on representation creation,
	...
	enum IndividualProperties
	{
		...
		/// <summary>	Enable the rendering of the bottom of the extrusion.  </summary>
		RENDER_BOTTOM = 24,
		/// <summary>	Exclude </summary>
		EXCLUDE,
		/// <summary>	Side texture url </summary>
		TEXTURE_SIDE_URL,
		/// <summary>	Top texture url </summary>
		TEXTURE_TOP_URL,
		/// <summary>	MAX - Do Not Use </summary>
		EPP_EPP_MAX			= 0xFFFF
	};
...
struct ExtrudedPathProperties
{
	...
	enum ConstructionProperties
	{
		...
		///				Minimum allowed effective value is 1 meter.
		///				A value of 0 will disable this setting.
		///				</remarks>
...
struct PointCloudProperties
{
	...
	enum PointCloudRenderModes
	{
		...
		HEIGHT_SHADING			= 0x3,
		/// <summary>	Display the intensity </summary>
		INTENSITY_MODE			= 0x4,
		/// <summary>	MAX - Do Not Use. </summary>
		PC_RM_MAX = 0xFFFF
	};

	enum PointCloudPixelSizeModes
	{
		/// <summary> Employs and adaptive pixel size algorithm	 </summary>
		ADAPTIVE_DEFAUT_SPACING_MODE = 0x0,
		/// <summary> Employs and adaptive pixel size algorithm	 </summary>
		ADAPTIVE_USE_USER_SPACING_MODE = 0x1,
		/// <summary> Uses the Min Max Pixel setting values	 </summary>
		USE_MIN_MAX_DIST_MODE = 0x2,
		/// <summary>	MAX - Do Not Use. </summary>
		PC_PSM_MAX = 0xFFFF
	};
	...
	enum LayerDefaultsOnlyProperties
	{
		/// <summary>	Render mode. </summary>
		RENDER_MODE = 16,
		/// <summary>	If rendering an intensity map, set to true to normalize the intensity values. </summary>
		...
		/// <summary>	Will start rendering nodes when they surpass this screen space size. [30 to 500]  </summary>
		MIN_NODE_SIZE = HEIGHT_SHADING_END_HEIGHT + 1,
		/// <summary>	Pixel Size Mode </summary>
		PIXEL_SIZE_MODE = MIN_NODE_SIZE + 1,
		/// <summary>	Render down to this LoD level [0 to 50] </summary>
		MAX_RENDER_LEVEL = PIXEL_SIZE_MODE + 1,
		/// <summary>	This is generally the minimum spacing expected for points in the root node of the dataset
		/// PoTree datasets will usually have this set. Set PIXEL_SIZE_MODE to ADAPTIVE_DEFAUT_SPACING_MODE
		/// to use the default of the data set. Set PIXEL_SIZE_MODE to ADAPTIVE_USE_USER_SPACING_MODE to use the set 
		/// value here. </summary>
		USER_MIN_SPACING = MAX_RENDER_LEVEL + 1,
		/// <summary>	MAX - Do Not Use </summary>
		PC_LYR_MAX = 0xFFFF
	};
...
struct BillboardProperties
{
	...
	enum IndividualProperties
	{
		...
		///so 100% will extend the leader line to the center of the billboard. </summary>
		...
		/// <summary>	Additional Texture palette index. 
		/// Currently uses the same anchor position of the texture found at the TEXTURE_PALETTE_INDEX.  
		/// Currently no blending (as to not effect primary texture fidelity)- if the texture referenced by TEXTURE_PALETTE_INDEX left any fully transparent
		/// pixels then this secondary texture will be able to write to them.</summary>
		SECONDARY_TEXTURE_PALETTE_IDX = 30,
		/// <summary>	MAX - Do Not Use </summary>
	...
	enum BILLBOARD_LEADER_MODE
	{
		...
		/// leader line is rendered from the "Z" value of the point to the terrain surface.</summary>
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// <summary>	Icon Properties </summary>
////////////////////////////////////////////////////////////////////////////////////////////////////
...
struct IconProperties
{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	Mode defining when label should be visible. </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	enum LabelMode 
	{
		/// <summary>	Label always off </summary>
		LABEL_OFF = 0,
		/// <summary>	Label visible when mouse hovers over an icon </summary>
		LABEL_HOVER,
		/// <summary>	Label always on </summary>
		LABEL_ON
	};

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	Mode defining balloon behavior when an icon is clicked. </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	enum BalloonContents 
	{
		/// <summary>	Display a balloon displaying a table of attributes for the clicked feature </summary>
		BALLOON_ATTR_TABLE,
		/// <summary>	Display a balloon containing just a single attribute value </summary>
		BALLOON_SINGLE_ATTR
	};

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	Mode defining when a balloon is displayed. </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	enum BalloonMode 
	{
		/// <summary>	No balloon displayed when an icon is clicked </summary>
		BALLOON_OFF = 0,
		/// <summary>	Balloon displayed only when a feature is clicked (and click mode is not CLICK_OFF) </summary>
		BALLOON_ON_CLICK,
		/// <summary>	Balloon is always active (this mode deactivates the 'pin' and 'close' buttons on the balloon). </summary>
		BALLOON_ON_ALWAYS
	};
	...
	enum IndividualProperties
	{
		...
		/// <summary>	Mode in which to interpret the vertical offset representations of features </summary>
		TRANSLATION_Z_OFFSET_MODE = 3,
		/// <summary>	Url/filepath of the icon (this can be a local filepath or a web url) </summary>
		RADIUS			= 4,
		/// <summary>	Relative scale of the icon (1.0 is native scale) </summary>
		ICON_URL			= 5,
		/// <summary>	Relative scale of the icon (1.0 is native scale) </summary>
		ICON_SCALE			= 6,
		/// <summary>	Rotation of the icon in degrees </summary>
		ICON_ROTATION		= 7,
		/// <summary>	Label mode for the icon </summary>
		LABEL_MODE			= 8,
		/// <summary>	Balloon mode for the icon </summary>
		BALLOON_MODE		= 9,
		/// <summary>	Label color - red (0.0 to 1.0)</summary>
		LABEL_RED			= 10,
		/// <summary>	Label color - green (0.0 to 1.0)</summary>
		LABEL_GREEN			= 11,
		/// <summary>	Label color - blue (0.0 to 1.0)</summary>
		LABEL_BLUE			= 12,
		/// <summary>	Label outline color - red </summary>
		LABEL_OUTLINE_RED	= 13,
		/// <summary>	Label outline color - green </summary>
		LABEL_OUTLINE_GREEN = 14,
		/// <summary>	Label outline color - blue </summary>
		LABEL_OUTLINE_BLUE	= 15,
		/// <summary>	Label point size (pixels) </summary>
		LABEL_POINT_SIZE	= 16,
		/// <summary>	Label font </summary>
		LABEL_FONT			= 17,
		/// <summary>	Field heading of the attribute to display as a label </summary>
		LABEL_ATTRIBUTE		= 18,
		/// <summary>	Field heading of the attribute to display as the balloon contents </summary>
		BALLOON_ATTRIBUTE	= 19,
		/// <summary>	Balloon contents ( </summary>
		BALLOON_CONTENTS	= 20,
		/// <summary>	Exclude </summary>
		EXCLUDE				= 21,
		/// <summary>	MAX - Do Not Use </summary>
