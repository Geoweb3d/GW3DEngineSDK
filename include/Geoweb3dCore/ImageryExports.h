...
struct ImageryLoadProperties
{
	ImageryLoadProperties() 
		...
		, page_level_( 0 )
		, screen_res_mode_(false)
		, resolution_mapping_(4)
		, activity(true)
		, use_invalid_replacement_color_(false)
		, invalid_replacement_red_(0.f)
		, invalid_replacement_blue_(0.f)
		, invalid_replacement_green_(0.f)
		, invalid_replacement_alpha_(0.f)
		, sampler_algo_(Geoweb3d::Raster::SamplerAlg::NEAREST_NEIGHBOR)
	{}
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	DEPRECATED (Use the tolerance range for invalid color.) Instead set the tolerance range to zero to turn off.  </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	DEPRECATED Error tolerance for imagery reprojection. </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	bool screen_res_mode_;

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	resolution mapping takes effect only if the screen_res_mode_ is set to true. 
	...
	bool use_invalid_replacement_color_;

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	Normalized invalid red value (range 0 - 1). </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	float invalid_replacement_red_;

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	Normalized invalid green value (range 0 - 1). </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	float invalid_replacement_blue_;

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	Normalized invalid blue value (range 0 - 1). </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	float invalid_replacement_green_;

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	Normalized invalid alpha value (range 0 - 1). 
	///				Currently only applied to overlay mode type rasters. 
	///		        If you are trying to to get blending in non-overlay mode see the global generic blend capability. </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	float invalid_replacement_alpha_;

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary> Sampling Algorithm.  </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	Geoweb3d::Raster::SamplerAlg sampler_algo_;

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary>	world file details are provided in this property, use them if this is true. </summary>
	////////////////////////////////////////////////////////////////////////////////////////////////////
...
///
/// <param name="map_source"> TODO </param>
/// <param name="map_series"> TODO </param>
/// <param name="scale_resolution"> TODO </param>
/// <param name="resolution_for_cib"> TODO </param>
/// <param name="scale_resolution_units"> TODO </param>
/// <param name="ret_handle"> TODO </param>
///
...
/// 			rasters on the filesystem.  Note || is the delimiter used for MFC's browser dialog 
...
///
/// <remarks>	Ability to set a pointer to your own data structure </remarks>
///
/// <param name="handle">	The handle. </param>
