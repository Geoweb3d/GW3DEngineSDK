...
public:
    ...
    /// 			state on construction, therefore if an envelope has never been set, it is null. </remarks>
    ///
    ...
    ///
    /// <remarks>	Expands the existing envelope dimensions to include the coordinate provided. </remarks>
    ///
    ...
    /// 			sOther. If this envelope is null, it will be set to the exact dimensions of sOther. </remarks>
    ///
	...
	/// 			to the exact dimensions of sOther. </remarks>
    ///
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <summary>	Flips Min and Max values if they are indeed max < min 
    /// When used for raster bounds it's often the case that a negative pixel size will make max < min.
    /// Ideally names of min and max should be more generic like top and bottom. 
    /// Note: the above utilities are not correct for reversed order. 
    /// This routine will reorder - until we address the usages. </summary>
    ////////////////////////////////////////////////////////////////////////////////////////////////////
...
///
/// <remarks>	This is the pure virtual base class for easy access to the underlying geometry type. </remarks>
////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary> Visit GW3DPoint. </summary>
	///
	/// <param name="p"> TODO </param>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	virtual void visit(GW3DPoint* p) = 0;

   	////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <summary> Visit GW3DLineString. </summary>
	///
    /// <param name="ls"> TODO </param>
	////////////////////////////////////////////////////////////////////////////////////////////////////

    virtual void visit(GW3DLineString* ls) = 0;

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary> Visit GW3DLinearRing. </summary>
	///
	/// <param name="lr"> TODO </param>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	virtual void visit(GW3DLinearRing* lr) = 0;

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary> Visit GW3DPolygon. </summary>
	///
	/// <param name="p"> TODO </param>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	virtual void visit(GW3DPolygon* p) = 0;

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary> Visit GW3DMultiPoint. </summary>
	///
	/// <param name="mp"> TODO </param>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	virtual void visit(GW3DMultiPoint* mp) = 0;

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary> Visit GW3DMultiLineString. </summary>
	///
	/// <param name="mls"> TODO </param>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	virtual void visit(GW3DMultiLineString* mls) = 0;

	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary> Visit GW3DMultiPolygon. </summary>
	///
	/// <param name="mp"> TODO </param>
	////////////////////////////////////////////////////////////////////////////////////////////////////

	virtual void visit(GW3DMultiPolygon* mp) = 0;
...
public:
    ...
    virtual void visit(const GW3DPoint* p) = 0;
    ...
    virtual void visit(const GW3DLineString* ls) = 0;
    ...
    virtual void visit(const GW3DLinearRing* lr) = 0;
    ...
    virtual void visit(const GW3DPolygon* p) = 0;
    ...
    virtual void visit(const GW3DMultiPoint* mp) = 0;
    ...
    virtual void visit(const GW3DMultiLineString* mls) = 0;
    ...
    virtual void visit(const GW3DMultiPolygon* mp) = 0;
...
///
/// <remarks>	This is the base class for all geometry objects (not including GW3DEnvelope). </remarks>
////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// <param name="other">	Tests if the other geometry is completely contained by this geometry. </param>
    ///
...
//SKIP-CODE-BEGIN
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <summary>	boundary of this object. </summary>
    ///
	/// <remarks>	Note: The returned object should be deleted when no longer needed, to prevent memory 
	/// 			leak. </remarks>
    ///
...
//SKIP-CODE-END
	...
	///
	/// <param name="IGW3DGeometryVisitor"> TODO </param>
	////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary> has a Z component. </summary>
	///
	/// <returns> TODO </returns>
	////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// <summary> has a M component. </summary>
	///
	/// <returns> TODO </returns>
	////////////////////////////////////////////////////////////////////////////////////////////////////
...
//SKIP-CODE-BEGIN
   ...
   // virtual GW3DGeometry *convex_hull() const;
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <summary>	convexhull of this object. </summary>
    ///
	/// <remarks>	Note: The returned object should be deleted when no longer needed, to prevent memory 
	/// 			leak. </remarks>
    ///
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// <summary>	A curve, abstract base for GW3DLineString and GW3DCompoundCurve. </summary>
////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// <param name="dfMaxLength">	The maximum distance between any 2 vertices after segmentization. </param>
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /// 			points as necessary. Use in conjunction with put_Point. </remarks>
    ///
	...
	/// 			points in the line string, the point count will be increased to accommodate the 
	/// 			request. </remarks>
    ///
...
///
/// <remarks>	This class is functionally equivalent to an GW3DLineString, but has a separate 
...
public:
    ...
    /// 
	/// <remarks>	If the index given is larger than the number of necessary the number of existing 
	/// 			points in the linear ring, the point count will be increased to accommodate the 
	/// 			request. </remarks>
    ///
    /// <param name="index">	Zero-based index of the vertex to assign. </param>
    /// <param name="point">	The value to assign to the vertex. </param>
    ...
    ///
    /// <param name="i">	Zero-based index of the point to retrieve. </param>
    /// <param name="p">	The point to be assigned the point at the given index. </param>
    ////////////////////////////////////////////////////////////////////////////////////////////////////
...
/// 			multiple islands in a political body).  The GW3DMultiPolygon must be used for this. </remarks>
////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// <remarks>	Convert geometry to strictly 2D. In a sense this converts all Z coordinates to 0.0. </remarks>
    ////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace GeometryFactory
{
    ...
    ///
    /// <remarks>	All arguments are in degrees; start/stop angles are clockwise of positive x </remarks>
    ///
    /// <param name="center_x"> TODO </param>
    /// <param name="center_y"> TODO </param>
    /// <param name="center_z"> TODO </param>
    /// <param name="x_radius"> TODO </param>
    /// <param name="y_radius"> TODO </param>
    /// <param name="rotation"> TODO </param>
    /// <param name="start_angle"> TODO </param>
    /// <param name="end_angle"> TODO </param>
    /// <param name="max_angle_step"> TODO </param>
	///
    /// <returns>	A GW3DGeometry. </returns>
    ////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// <summary>	Geometry Utility </summary>
////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace GeometryUtility
{
	...
	///				Longitudes must be [-180.0, 180.0] and not equal. </remarks>
	///
	/// <param name="env"> TODO </param>
	/// <param name="north"> TODO </param>
	/// <param name="south"> TODO </param>
	/// <param name="west"> TODO </param>
	/// <param name="east"> TODO </param>
	///
	/// <returns> TODO </returns>
	////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// <summary>	A factory for creating spatial databases . </summary>
////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace SpatialDatabaseFactory
{
	...
	/// <summary> TODO </summary>
	///
	/// <returns> A IGW3DSpatialDatabase</returns>
	////////////////////////////////////////////////////////////////////////////////////////////////////
