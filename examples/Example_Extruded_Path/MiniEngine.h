...
private:
	...
	void PopulateCurrentExtrudedPathStateProps(Geoweb3d::IGW3DVectorRepresentationWPtr extruded_rep, const long current_fid);
	void PopulateCurrentExtrudedPathDynamicStateProps(Geoweb3d::IGW3DVectorRepresentationWPtr extruded_rep, const long current_fid);
...
private:
	...
	struct prop_state
	{
		...
		Geoweb3d::Vector::OITMode oit_mode_;
	...
	prop_state default_state_extruded_path_prop_;
	prop_state specific_state_extruded_path_prop_;
	prop_state default_state_extruded_path_dynamic_prop_;
	prop_state specific_state_extruded_path_dynamic_prop_;
	

	/// <summary>	The extruded representation. </summary>
	Geoweb3d::IGW3DVectorRepresentationWPtr extruded_path_rep_;
	Geoweb3d::IGW3DVectorRepresentationWPtr extruded_path_dynamic_rep_;

	Geoweb3d::IGW3DPropertyCollectionPtr extruded_path_properties_;
	Geoweb3d::IGW3DPropertyCollectionPtr extruded_path_properties2_;

	Geoweb3d::IGW3DVectorDataSourceWPtr dynamic_path_datasource_;
	Geoweb3d::IGW3DVectorLayerWPtr dynamic_path_layer_;
	ExtrudedPathController dynamic_path_stream_;
