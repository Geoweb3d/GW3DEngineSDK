...
class MiniEngine : public Geoweb3d::IGW3DEventStream, public Geoweb3d::IGW3DWindowCallback, public MiniEngineCore
{
public:
...
private:
	...
	IntersectionTestHandler *intersection_test_handler_;
	ViewshedHandler *viewshed_handler_;
