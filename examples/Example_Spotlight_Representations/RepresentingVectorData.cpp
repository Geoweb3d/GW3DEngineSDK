...
/// <summary>	The myinfobuf[ 1024]. </summary>
...
void RunApplication( Geoweb3d::IGW3DGeoweb3dSDKPtr sdk_context )
{
    ...
    if( pengine->LoadConfiguration( "Example 9 - Representing Vector Data" ) )
    {
        ...
        while( pengine->Update() )
        {
			...
			Geoweb3d::IGW3DEnvironmentEffects* camera_effects = pengine->GetCamera().lock()->get_EnvironmentEffects();
          
			// Change some weather effects over time
			if( example_timer == 100 )
				camera_effects->put_Precipitation( Geoweb3d::IGW3DEnvironmentEffects::RAIN, 5.0 );

			if( example_timer == 500 )
				camera_effects->put_Precipitation( Geoweb3d::IGW3DEnvironmentEffects::WET_SNOW, 1.0 );

			if( example_timer == 1000 )
				camera_effects->put_Precipitation( Geoweb3d::IGW3DEnvironmentEffects::NONE, 5.0 );
        }
    }
...
void my_info_function(const char *msg,...)
{
    ...
    vsprintf_s( myinfobuf, msg, ap );
    va_end( ap );
	std::cout<< "General Info: "<<myinfobuf;
}

/*! Information handling is not required */

////////////////////////////////////////////////////////////////////////////////////////////////////
/// <summary>	Sets infomation handling. </summary>
///
/// <remarks>	Geoweb3d, 11/2/2012. </remarks>
////////////////////////////////////////////////////////////////////////////////////////////////////
