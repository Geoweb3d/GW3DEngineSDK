...
#include "engine/IGW3DViewshedTest.h"
#include "engine/IGW3DViewshedTestCollection.h"
...
#include <iostream>
	...
	void ViewshedHandler::ToggleViewshed(Geoweb3d::IGW3DCameraWPtr& camera)
	{
        ...
        {
            viewshed_test_ = sdk_context_->get_ViewshedTestCollection()->create();
        ...
        else
        {
            ...
            Geoweb3d::IGW3DViewshedTestCollection::close( viewshed_test_ );
        }
	}
