...
class OpenGLPaletteCreator : public Geoweb3d::IGW3DVectorLayerStream
{

public:
    OpenGLPaletteCreator( Geoweb3d::IGW3DGeoweb3dSDKPtr &sdk_context, int color_property_index );
    virtual ~OpenGLPaletteCreator(void);
	...
	Geoweb3d::IGW3DOpenGLTextureFinalizationTokenPtr GetPalletToken();


	Geoweb3d::IGW3DOpenGLTextureCollectionPtr palette;

protected:
	int color_property_index_;
	Geoweb3d::IGW3DOpenGLTextureWPtr red_;
	Geoweb3d::IGW3DOpenGLTextureWPtr green_;
