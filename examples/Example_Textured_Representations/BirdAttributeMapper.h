...
class BirdAttributeMapper : public Geoweb3d::IGW3DVectorLayerStream
{

public:
    BirdAttributeMapper( Geoweb3d::IGW3DImageCollectionPtr imagepalette, int filename_property_index, int fid_property_idx, Geoweb3d::IGW3DVectorRepresentationWPtr rep);
    virtual ~BirdAttributeMapper(void);
