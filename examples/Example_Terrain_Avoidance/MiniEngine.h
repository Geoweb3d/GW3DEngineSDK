...
private:
    ...
    TerrainAvoidanceHandler *terrain_avoidance_handler_;
	Geoweb3d::IGW3DVectorRepresentationWPtr draped_ring_rep_;
	Geoweb3d::IGW3DVectorRepresentationWPtr model_rep_;
	Geoweb3d::IGW3DVectorRepresentationWPtr point_cloud_rep_;

	Geoweb3d::IGW3DTerrainAvoidanceTest::IncreasedDetailMode detail_mode_;
