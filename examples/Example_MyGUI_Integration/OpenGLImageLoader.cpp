...
void OpenGLImageLoader_Devil::saveImage(int _width, int _height, MyGUI::PixelFormat _format, void* _texture, const std::string& _filename)
{

}

void* OpenGLImageLoader_Devil::loadImage(
    int& _width,
    int& _height,
