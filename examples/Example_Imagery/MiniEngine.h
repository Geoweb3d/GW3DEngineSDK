...
private:
	...
	Geoweb3d::IGW3DRasterRepresentationWPtr imgery_rep_;
	Geoweb3d::IGW3DPropertyCollectionPtr imagery_rep_props_;

	int sampler_algorithm_index_ = 1;
	bool screen_res_mode_ = true;
}; //engine end of class