...
void RunApplication(  Geoweb3d::IGW3DGeoweb3dSDKPtr sdk_context )
{
	...
	if (Geoweb3d::Succeeded(field_values->put_Property(0,0.0)))
	{
	...
	Geoweb3d::IGW3DWindowWPtr window = sdk_context->get_WindowCollection(  )->create_3DWindow("Line Representations", GW3D_OVERLAPPED, 10, 10, 1280,720, 0, Geoweb3d::IGW3DStereoDriverPtr(), 0);

	// Just showing how to tell the SDK to draw one frame for a given window
